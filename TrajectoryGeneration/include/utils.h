...
struct ManipulabilityEllipsoid {
    Eigen::Vector3d eigenvalues;     // Principal axes lengths
    Eigen::Matrix3d eigenvectors;    // Principal axes directions
    double manipulability_measure;   // Scalar manipulability measure (determinant)
};
