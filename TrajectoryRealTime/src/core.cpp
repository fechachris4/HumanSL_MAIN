...
// Define macros that call TaskParameters functions
#define GPMP2_TIMESTEPS TaskParameters::get("GPMP2_TIMESTEPS")
#define JOINT_CONTROL_FREQUENCY TaskParameters::get("JOINT_CONTROL_FREQUENCY")
#define TIME_SCALE TaskParameters::get("TIME_SCALE")

// Case 1: Right arm engages pipe
#define NORMAL_1_OFFSET_Y TaskParameters::get("NORMAL_1_OFFSET_Y")
#define NORMAL_1_OFFSET_Z TaskParameters::get("NORMAL_1_OFFSET_Z")
#define NORMAL_1_TIME_SEC TaskParameters::get("NORMAL_1_TIME_SEC")
#define NORMAL_1_ANGLE_LIMIT TaskParameters::get("NORMAL_1_ANGLE_LIMIT")
#define NORMAL_1_Y_POS_TOLERANCE TaskParameters::get("NORMAL_1_Y_POS_TOLERANCE")
#define NORMAL_1_Y_ROT_TOLERANCE TaskParameters::get("NORMAL_1_Y_ROT_TOLERANCE")

#define MIRROR_1_OFFSET_Y TaskParameters::get("MIRROR_1_OFFSET_Y")
#define MIRROR_1_OFFSET_Z TaskParameters::get("MIRROR_1_OFFSET_Z")
#define MIRROR_1_TIME_SEC TaskParameters::get("MIRROR_1_TIME_SEC")
#define MIRROR_1_ANGLE_LIMIT TaskParameters::get("MIRROR_1_ANGLE_LIMIT")
#define MIRROR_1_Y_POS_TOLERANCE TaskParameters::get("MIRROR_1_Y_POS_TOLERANCE")
#define MIRROR_1_Y_ROT_TOLERANCE TaskParameters::get("MIRROR_1_Y_ROT_TOLERANCE")

// Case 2: Right arm grasps pipe
#define NORMAL_2_TIME_SEC TaskParameters::get("NORMAL_2_TIME_SEC")
#define MIRROR_2_TIME_SEC TaskParameters::get("MIRROR_2_TIME_SEC")

// Case 3: Right arm moves pipe task space controlled
#define NORMAL_3_TIME_SEC TaskParameters::get("NORMAL_3_TIME_SEC")
#define NORMAL_3_TIME_STEP TaskParameters::get("NORMAL_3_TIME_STEP")
#define NORMAL_3_INTERMEDIATE_PERCENTAGE TaskParameters::get("NORMAL_3_INTERMEDIATE_PERCENTAGE")
#define NORMAL_3_INTERMEDIATE_Z_OFFSET TaskParameters::get("NORMAL_3_INTERMEDIATE_Z_OFFSET")
#define NORMAL_3_INTERMEDIATE_Y_OFFSET TaskParameters::get("NORMAL_3_INTERMEDIATE_Y_OFFSET")
#define NORMAL_3_BASE_OFFSET_Y TaskParameters::get("NORMAL_3_BASE_OFFSET_Y")
#define NORMAL_3_HEAD_OFFSET_X TaskParameters::get("NORMAL_3_HEAD_OFFSET_X")
#define NORMAL_3_HEAD_OFFSET_Z TaskParameters::get("NORMAL_3_HEAD_OFFSET_Z")
#define NORMAL_3_Y_POS_TOLERANCE TaskParameters::get("NORMAL_3_Y_POS_TOLERANCE")
#define NORMAL_3_Y_ROT_TOLERANCE TaskParameters::get("NORMAL_3_Y_ROT_TOLERANCE")

#define MIRROR_3_TIME_SEC TaskParameters::get("MIRROR_3_TIME_SEC")
#define MIRROR_3_TIME_STEP TaskParameters::get("MIRROR_3_TIME_STEP")
#define MIRROR_3_INTERMEDIATE_PERCENTAGE TaskParameters::get("MIRROR_3_INTERMEDIATE_PERCENTAGE")
#define MIRROR_3_INTERMEDIATE_Z_OFFSET TaskParameters::get("MIRROR_3_INTERMEDIATE_Z_OFFSET")
#define MIRROR_3_INTERMEDIATE_Y_OFFSET TaskParameters::get("MIRROR_3_INTERMEDIATE_Y_OFFSET")
#define MIRROR_3_BASE_OFFSET_Y TaskParameters::get("MIRROR_3_BASE_OFFSET_Y")
#define MIRROR_3_HEAD_OFFSET_X TaskParameters::get("MIRROR_3_HEAD_OFFSET_X")
#define MIRROR_3_HEAD_OFFSET_Z TaskParameters::get("MIRROR_3_HEAD_OFFSET_Z")
#define MIRROR_3_Y_POS_TOLERANCE TaskParameters::get("MIRROR_3_Y_POS_TOLERANCE")
#define MIRROR_3_Y_ROT_TOLERANCE TaskParameters::get("MIRROR_3_Y_ROT_TOLERANCE")

// Case 4: Left arm approaches pipe
#define NORMAL_4_OFFSET_Y TaskParameters::get("NORMAL_4_OFFSET_Y")
#define NORMAL_4_OFFSET_Z TaskParameters::get("NORMAL_4_OFFSET_Z")
#define NORMAL_4_TIME_SEC TaskParameters::get("NORMAL_4_TIME_SEC")
#define NORMAL_4_ANGLE TaskParameters::get("NORMAL_4_ANGLE")
#define NORMAL_4_Y_POS_TOLERANCE TaskParameters::get("NORMAL_4_Y_POS_TOLERANCE")
#define NORMAL_4_Y_ROT_TOLERANCE TaskParameters::get("NORMAL_4_Y_ROT_TOLERANCE")

#define MIRROR_4_OFFSET_Y TaskParameters::get("MIRROR_4_OFFSET_Y")
#define MIRROR_4_OFFSET_Z TaskParameters::get("MIRROR_4_OFFSET_Z")
#define MIRROR_4_TIME_SEC TaskParameters::get("MIRROR_4_TIME_SEC")
#define MIRROR_4_ANGLE TaskParameters::get("MIRROR_4_ANGLE")
#define MIRROR_4_Y_POS_TOLERANCE TaskParameters::get("MIRROR_4_Y_POS_TOLERANCE")
#define MIRROR_4_Y_ROT_TOLERANCE TaskParameters::get("MIRROR_4_Y_ROT_TOLERANCE")

#define SUB_ACTION_4_EE_Y_OFFSETS TaskParameters::get("SUB_ACTION_4_EE_Y_OFFSETS")

// Case 5: Left arm grasps pipe
#define NORMAL_5_TIME_SEC TaskParameters::get("NORMAL_5_TIME_SEC")
#define MIRROR_5_TIME_SEC TaskParameters::get("MIRROR_5_TIME_SEC")

// Case 6: Right arm disengages pipe
#define NORMAL_6_TIME_SEC TaskParameters::get("NORMAL_6_TIME_SEC")
#define MIRROR_6_TIME_SEC TaskParameters::get("MIRROR_6_TIME_SEC")

// Case 8: Left arm moves to target
#define NORMAL_8_TIME_SEC TaskParameters::get("NORMAL_8_TIME_SEC")
#define NORMAL_8_TIME_STEP TaskParameters::get("NORMAL_8_TIME_STEP")
#define NORMAL_8_INTERMEDIATE_PERCENTAGE TaskParameters::get("NORMAL_8_INTERMEDIATE_PERCENTAGE")
#define NORMAL_8_INTERMEDIATE_Z_OFFSET TaskParameters::get("NORMAL_8_INTERMEDIATE_Z_OFFSET")
#define NORMAL_8_INTERMEDIATE_Y_OFFSET TaskParameters::get("NORMAL_8_INTERMEDIATE_Y_OFFSET")
#define NORMAL_8_Y_POS_TOLERANCE TaskParameters::get("NORMAL_8_Y_POS_TOLERANCE")
#define NORMAL_8_Y_ROT_TOLERANCE TaskParameters::get("NORMAL_8_Y_ROT_TOLERANCE")
#define NORMAL_8_Z_ROT_TOLERANCE TaskParameters::get("NORMAL_8_Z_ROT_TOLERANCE")

#define MIRROR_8_TIME_SEC TaskParameters::get("MIRROR_8_TIME_SEC")
#define MIRROR_8_TIME_STEP TaskParameters::get("MIRROR_8_TIME_STEP")
#define MIRROR_8_INTERMEDIATE_PERCENTAGE TaskParameters::get("MIRROR_8_INTERMEDIATE_PERCENTAGE")
#define MIRROR_8_INTERMEDIATE_Z_OFFSET TaskParameters::get("MIRROR_8_INTERMEDIATE_Z_OFFSET")
#define MIRROR_8_INTERMEDIATE_Y_OFFSET TaskParameters::get("MIRROR_8_INTERMEDIATE_Y_OFFSET")
#define MIRROR_8_Y_POS_TOLERANCE TaskParameters::get("MIRROR_8_Y_POS_TOLERANCE")
#define MIRROR_8_Y_ROT_TOLERANCE TaskParameters::get("MIRROR_8_Y_ROT_TOLERANCE")
#define MIRROR_8_Z_ROT_TOLERANCE TaskParameters::get("MIRROR_8_Z_ROT_TOLERANCE")

// Gripper positions (0 is fully open, 100 is fully closed)
#define MOVE_GRIPPER_2 TaskParameters::get("MOVE_GRIPPER_2")
#define MOVE_GRIPPER_5 TaskParameters::get("MOVE_GRIPPER_5")
#define MOVE_GRIPPER_6 TaskParameters::get("MOVE_GRIPPER_6")
#define MOVE_GRIPPER_8 TaskParameters::get("MOVE_GRIPPER_8")
...
bool plan_action(
    ...
    std::mutex& trajectory_mutex
        ...
        switch(trigger_id){
            case 1: // Right arm engages pipe
            {
                double approach_offset_y = NORMAL_1_OFFSET_Y;
                double approach_offset_z = NORMAL_1_OFFSET_Z;
                double approach_time_sec = NORMAL_1_TIME_SEC * TIME_SCALE;

                right_arm.make_sdf(tube_info_snapshot, human_info_snapshot, true, right_base_frame_snapshot, left_base_frame_snapshot, q_cur_left_snapshot);
                right_arm.plan_joint(right_new_joint_trajectory, q_cur_right_snapshot, right_base_frame_snapshot,
                                    ...
                                    approach_time_sec, GPMP2_TIMESTEPS, JOINT_CONTROL_FREQUENCY, NORMAL_1_ANGLE_LIMIT, true, NORMAL_1_Y_POS_TOLERANCE, NORMAL_1_Y_ROT_TOLERANCE);
            ...
            case 2: // Right arm grasps pipe
            {
                JointTrajectory right_new_joint_trajectory_x;
                JointTrajectory right_new_joint_trajectory_z;
                JointTrajectory right_new_joint_trajectory_buffer;


                double grasp_time_sec_x = NORMAL_2_TIME_SEC/2.0;
                double grasp_time_sec_z = NORMAL_2_TIME_SEC;
                ...
                right_arm.plan_cartesian_x(right_new_joint_trajectory_x, q_cur_right_snapshot, right_base_frame_snapshot, tube_info_snapshot, grasp_time_sec_x, JOINT_CONTROL_FREQUENCY);

                visualizeTrajectory(right_new_joint_trajectory_x.pos, right_arm.arm_model_logs, right_arm.dataset_logs, right_base_frame_snapshot);

                // Fill buffer with 250 elements of last element of right_new_joint_trajectory_x
                for (int i = 0; i < (JOINT_CONTROL_FREQUENCY/2); ++i) {
                    right_new_joint_trajectory_buffer.pos.push_back(right_new_joint_trajectory_x.pos.back());
                    right_new_joint_trajectory_buffer.vel.push_back(Eigen::VectorXd::Zero(7));
                    right_new_joint_trajectory_buffer.acc.push_back(Eigen::VectorXd::Zero(7));
                }
                // End Fill

                std::vector<double> std_vec2(right_new_joint_trajectory_x.pos.back().data(), right_new_joint_trajectory_x.pos.back().data() + right_new_joint_trajectory_x.pos.back().size());
                q_cur_right_snapshot = std_vec2;
                right_arm.plan_cartesian_z(right_new_joint_trajectory_z, q_cur_right_snapshot, right_base_frame_snapshot, tube_info_snapshot, grasp_time_sec_z, JOINT_CONTROL_FREQUENCY, true);
            
                visualizeTrajectory(right_new_joint_trajectory_z.pos, right_arm.arm_model_logs, right_arm.dataset_logs, right_base_frame_snapshot);
                
                {
                    // Concatenate x trajectory
                    right_new_joint_trajectory.pos.insert(right_new_joint_trajectory.pos.end(),
                        right_new_joint_trajectory_x.pos.begin(), right_new_joint_trajectory_x.pos.end());
                    right_new_joint_trajectory.vel.insert(right_new_joint_trajectory.vel.end(),
                        right_new_joint_trajectory_x.vel.begin(), right_new_joint_trajectory_x.vel.end());
                    right_new_joint_trajectory.acc.insert(right_new_joint_trajectory.acc.end(),
                        right_new_joint_trajectory_x.acc.begin(), right_new_joint_trajectory_x.acc.end());

                    // Concatenate buffer trajectory
                    right_new_joint_trajectory.pos.insert(right_new_joint_trajectory.pos.end(),
                        right_new_joint_trajectory_buffer.pos.begin(), right_new_joint_trajectory_buffer.pos.end());
                    right_new_joint_trajectory.vel.insert(right_new_joint_trajectory.vel.end(),
                        right_new_joint_trajectory_buffer.vel.begin(), right_new_joint_trajectory_buffer.vel.end());
                    right_new_joint_trajectory.acc.insert(right_new_joint_trajectory.acc.end(),
                        right_new_joint_trajectory_buffer.acc.begin(), right_new_joint_trajectory_buffer.acc.end());

                    // Concatenate z trajectory
                    right_new_joint_trajectory.pos.insert(right_new_joint_trajectory.pos.end(),
                        right_new_joint_trajectory_z.pos.begin(), right_new_joint_trajectory_z.pos.end());
                    right_new_joint_trajectory.vel.insert(right_new_joint_trajectory.vel.end(),
                        right_new_joint_trajectory_z.vel.begin(), right_new_joint_trajectory_z.vel.end());
                    right_new_joint_trajectory.acc.insert(right_new_joint_trajectory.acc.end(),
                        right_new_joint_trajectory_z.acc.begin(), right_new_joint_trajectory_z.acc.end());
                }
            ...
            case 3: // Right arm moves pipe task space controlled
            {
                double move_time_sec = NORMAL_3_TIME_SEC * TIME_SCALE;
                double move_time_step = NORMAL_3_TIME_STEP;
                double intermediate_point_percentage = NORMAL_3_INTERMEDIATE_PERCENTAGE;
                double intermediate_point_z_offset = NORMAL_3_INTERMEDIATE_Z_OFFSET;
                double intermediate_point_y_offset = NORMAL_3_INTERMEDIATE_Y_OFFSET;

                double move_offset_from_base_y = NORMAL_3_BASE_OFFSET_Y; // position the gripper furter behind human
                double move_offset_from_head_x = NORMAL_3_HEAD_OFFSET_X; // positive means moving the end pose towards human left
                double move_offset_from_head_z = NORMAL_3_HEAD_OFFSET_Z;
                ...
                right_arm.make_sdf(tube_info_snapshot, human_info_snapshot, false, right_base_frame_snapshot, left_base_frame_snapshot, q_cur_left_snapshot);
                right_arm.plan_task(right_new_joint_trajectory, start_pose, target_pose,
                                    ...
                                    intermediate_point_z_offset, intermediate_point_y_offset, JOINT_CONTROL_FREQUENCY, false, NORMAL_3_Y_POS_TOLERANCE, NORMAL_3_Y_ROT_TOLERANCE);
            ...
            case 4: // Left arm approaches pipe
            {
                ...
                double approach_offset_y = abs(right_ee_pose.translation().y() - left_base_frame_snapshot.translation().y()) + SUB_ACTION_4_EE_Y_OFFSETS;
                double approach_offset_z = MIRROR_4_OFFSET_Z;
                double approach_time_sec = MIRROR_4_TIME_SEC;

                std::cout << "\n\n\n\n left sub-action 4 y_offset: " << approach_offset_y << "\n\n\n";

                left_arm.make_sdf(tube_info_snapshot, human_info_snapshot, true, left_base_frame_snapshot, right_base_frame_snapshot, q_cur_right_snapshot);
                ...
                left_arm.plan_joint(left_new_joint_trajectory, q_cur_left_snapshot, left_base_frame_snapshot,
                                    tube_info_snapshot,
                                    approach_offset_y, approach_offset_z,
                                    approach_time_sec, GPMP2_TIMESTEPS, JOINT_CONTROL_FREQUENCY, NORMAL_4_ANGLE, false, NORMAL_4_Y_POS_TOLERANCE, NORMAL_4_Y_ROT_TOLERANCE);
            ...
            case 5: // Left arm grasps pipe
            {
                ...
                JointTrajectory left_new_joint_trajectory_x;
                JointTrajectory left_new_joint_trajectory_z;
                JointTrajectory left_new_joint_trajectory_buffer;


                double grasp_time_sec_x = NORMAL_5_TIME_SEC/2.0;
                double grasp_time_sec_z = NORMAL_5_TIME_SEC;
                ...
                std::vector<double> std_vec1(left_joint_trajectory.pos.back().data(), left_joint_trajectory.pos.back().data() + left_joint_trajectory.pos.back().size());
                q_cur_left_snapshot = std_vec1;
                left_arm.plan_cartesian_x(left_new_joint_trajectory_x, q_cur_left_snapshot, left_base_frame_snapshot, tube_info_snapshot, grasp_time_sec_x, JOINT_CONTROL_FREQUENCY);

                visualizeTrajectory(left_new_joint_trajectory_x.pos, left_arm.arm_model_logs, left_arm.dataset_logs, left_base_frame_snapshot);

                // Buffer traj for some pause
                for (int i = 0; i < (JOINT_CONTROL_FREQUENCY/2); ++i) {
                    left_new_joint_trajectory_buffer.pos.push_back(left_new_joint_trajectory_x.pos.back());
                    left_new_joint_trajectory_buffer.vel.push_back(Eigen::VectorXd::Zero(7));
                    left_new_joint_trajectory_buffer.acc.push_back(Eigen::VectorXd::Zero(7));
                }
                

                std::vector<double> std_vec2(left_new_joint_trajectory_x.pos.back().data(), left_new_joint_trajectory_x.pos.back().data() + left_new_joint_trajectory_x.pos.back().size());
                q_cur_left_snapshot = std_vec2;
                left_arm.plan_cartesian_z(left_new_joint_trajectory_z, q_cur_left_snapshot, left_base_frame_snapshot, tube_info_snapshot, grasp_time_sec_z, JOINT_CONTROL_FREQUENCY, true);
            
                visualizeTrajectory(left_new_joint_trajectory_z.pos, left_arm.arm_model_logs, left_arm.dataset_logs, left_base_frame_snapshot);
                
                {
                    // Concatenate x trajectory
                    left_new_joint_trajectory.pos.insert(left_new_joint_trajectory.pos.end(),
                        left_new_joint_trajectory_x.pos.begin(), left_new_joint_trajectory_x.pos.end());
                    left_new_joint_trajectory.vel.insert(left_new_joint_trajectory.vel.end(),
                        left_new_joint_trajectory_x.vel.begin(), left_new_joint_trajectory_x.vel.end());
                    left_new_joint_trajectory.acc.insert(left_new_joint_trajectory.acc.end(),
                        left_new_joint_trajectory_x.acc.begin(), left_new_joint_trajectory_x.acc.end());

                    // Concatenate buffer trajectory
                    left_new_joint_trajectory.pos.insert(left_new_joint_trajectory.pos.end(),
                        left_new_joint_trajectory_buffer.pos.begin(), left_new_joint_trajectory_buffer.pos.end());
                    left_new_joint_trajectory.vel.insert(left_new_joint_trajectory.vel.end(),
                        left_new_joint_trajectory_buffer.vel.begin(), left_new_joint_trajectory_buffer.vel.end());
                    left_new_joint_trajectory.acc.insert(left_new_joint_trajectory.acc.end(),
                        left_new_joint_trajectory_buffer.acc.begin(), left_new_joint_trajectory_buffer.acc.end());

                    // Concatenate z trajectory
                    left_new_joint_trajectory.pos.insert(left_new_joint_trajectory.pos.end(),
                        left_new_joint_trajectory_z.pos.begin(), left_new_joint_trajectory_z.pos.end());
                    left_new_joint_trajectory.vel.insert(left_new_joint_trajectory.vel.end(),
                        left_new_joint_trajectory_z.vel.begin(), left_new_joint_trajectory_z.vel.end());
                    left_new_joint_trajectory.acc.insert(left_new_joint_trajectory.acc.end(),
                        left_new_joint_trajectory_z.acc.begin(), left_new_joint_trajectory_z.acc.end());
                }
            ...
            case 6: // Right arm disengages pipe
            {
                ...
                right_arm.plan_cartesian_z(right_new_joint_trajectory, q_cur_right_snapshot, right_base_frame_snapshot, tube_info_snapshot, NORMAL_6_TIME_SEC, JOINT_CONTROL_FREQUENCY, false);
            ...
            case 7: // Right arm moves back to default position
            {
                ...
                // double disengage_time_sec = NORMAL_7_TIME_SEC;
            ...
            case 8: // Left arm moves to target
            {
                ...
                double move_time_sec = NORMAL_8_TIME_SEC * TIME_SCALE;
                int move_time_step = NORMAL_8_TIME_STEP;
                double intermediate_point_z_offset = NORMAL_8_INTERMEDIATE_Z_OFFSET;
                double intermediate_point_y_offset = NORMAL_8_INTERMEDIATE_Y_OFFSET;
                double intermediate_point_percentage = NORMAL_8_INTERMEDIATE_PERCENTAGE;

                std::cout << "\nTarget Installation Pose: " << target_pose << "\n\n";

                left_arm.make_sdf(tube_info_snapshot, human_info_snapshot, false, left_base_frame_snapshot, right_base_frame_snapshot, q_cur_right_snapshot);
                ...
                //      intermediate_point_z_offset,
                //      intermediate_point_y_offset,
                //      JOINT_CONTROL_FREQUENCY,
                //      false,
                //      TaskParameters::get("NORMAL_8_Y_POS_TOLERANCE", 0.1), TaskParameters::get("NORMAL_8_Y_ROT_TOLERANCE", 0.1), TaskParameters::get("NORMAL_8_Z_ROT_TOLERANCE", 0.5));
                ...
                left_arm.plan_cartesian_target(left_new_joint_trajectory, q_cur_left_snapshot, left_base_frame_snapshot, target_info, move_time_sec, JOINT_CONTROL_FREQUENCY);
...
bool plan_action_mirror(
    ...
    std::mutex& trajectory_mutex
        ...
        switch(trigger_id){
            case 1: // Right arm engages pipe
            {
                double approach_offset_y = MIRROR_1_OFFSET_Y;
                double approach_offset_z = MIRROR_1_OFFSET_Z;
                double approach_time_sec = MIRROR_1_TIME_SEC * TIME_SCALE;

                right_arm.make_sdf(tube_info_snapshot, human_info_snapshot, true, right_base_frame_snapshot, left_base_frame_snapshot, q_cur_left_snapshot);
                right_arm.plan_joint(right_new_joint_trajectory, q_init_right, right_base_frame_snapshot, 
                                    tube_info_snapshot,
                                    approach_offset_y, approach_offset_z,
                                    approach_time_sec, GPMP2_TIMESTEPS, JOINT_CONTROL_FREQUENCY, MIRROR_1_ANGLE_LIMIT, true, MIRROR_1_Y_POS_TOLERANCE, MIRROR_1_Y_ROT_TOLERANCE);
            ...
            case 2: // Right arm grasps pipe
            {
                ...
                double grasp_time_sec_x = MIRROR_2_TIME_SEC/2.0;
                double grasp_time_sec_z = MIRROR_2_TIME_SEC;
            ...
            {
                // sub-action 3
                double move_time_sec = MIRROR_3_TIME_SEC * TIME_SCALE;
                double move_time_step = MIRROR_3_TIME_STEP;
                double intermediate_point_percentage = MIRROR_3_INTERMEDIATE_PERCENTAGE;
                double intermediate_point_z_offset = MIRROR_3_INTERMEDIATE_Z_OFFSET;
                double intermediate_point_y_offset = MIRROR_3_INTERMEDIATE_Y_OFFSET;
                // sub_action 4
                double move_offset_from_base_y = MIRROR_3_BASE_OFFSET_Y; // position the gripper furter behind human
                double move_offset_from_head_x = MIRROR_3_HEAD_OFFSET_X; // positive means moving the end pose towards human left
                double move_offset_from_head_z = MIRROR_3_HEAD_OFFSET_Z;
                ...
                right_arm.plan_task(right_new_joint_trajectory, start_pose, target_pose,
                                    right_base_frame_snapshot, q_cur_right_snapshot,
                                    move_time_sec, move_time_step, intermediate_point_percentage,
                                    intermediate_point_z_offset, intermediate_point_y_offset, JOINT_CONTROL_FREQUENCY, false, MIRROR_3_Y_POS_TOLERANCE, MIRROR_3_Y_ROT_TOLERANCE);
                ...
                // double approach_offset_y = MIRROR_4_OFFSET_Y;
                double approach_offset_y = abs(right_ee_pose.translation().y() - left_base_frame_snapshot.translation().y()) + SUB_ACTION_4_EE_Y_OFFSETS;
                double approach_offset_z = MIRROR_4_OFFSET_Z;
                double approach_time_sec = MIRROR_4_TIME_SEC;
                ...
                left_arm.make_sdf(tube_info_snapshot, human_info_snapshot, true, left_base_frame_snapshot, right_base_frame_snapshot, final_right);
                ...
                left_arm.plan_joint(left_new_joint_trajectory, q_cur_left_snapshot, left_base_frame_snapshot,
                                    tube_info_snapshot,
                                    approach_offset_y, approach_offset_z,
                                    approach_time_sec, GPMP2_TIMESTEPS, JOINT_CONTROL_FREQUENCY, MIRROR_4_ANGLE, false, MIRROR_4_Y_POS_TOLERANCE, MIRROR_4_Y_ROT_TOLERANCE);
            ...
            case 5: // Left arm grasps pipe
            {
                ...
                double grasp_time_sec_x = MIRROR_5_TIME_SEC/2.0;
                double grasp_time_sec_z = MIRROR_5_TIME_SEC;
            ...
            case 6: // Right arm disengages pipe
            {
                ...
                right_arm.plan_cartesian_z(right_new_joint_trajectory, q_cur_right_snapshot, right_base_frame_snapshot, tube_info_snapshot, MIRROR_6_TIME_SEC, JOINT_CONTROL_FREQUENCY, false);
            ...
            case 8: // Left arm moves to target
            {
                ...
                double move_time_sec = MIRROR_8_TIME_SEC * TIME_SCALE;
                int move_time_step = MIRROR_8_TIME_STEP;
                double intermediate_point_percentage = MIRROR_8_INTERMEDIATE_PERCENTAGE;
                double intermediate_point_z_offset = MIRROR_8_INTERMEDIATE_Z_OFFSET;
                double intermediate_point_y_offset = MIRROR_8_INTERMEDIATE_Y_OFFSET;
                ...
                //      JOINT_CONTROL_FREQUENCY,
                //      false,
                //      MIRROR_8_Y_POS_TOLERANCE, MIRROR_8_Y_ROT_TOLERANCE, MIRROR_8_Z_ROT_TOLERANCE);
...
void state_transition(
    ...
    if(prev_state_idx.load() == 0 && state_idx.load() == 1){
        ...
        for(int i = 1; i <= 3; i++){
            ...
            if(i == 2){
                move_gripper(right_base_cyclic, MOVE_GRIPPER_2);
            }
    ...
    if(prev_state_idx.load() == 1 && state_idx.load() == 2){
        ...
        for(int i = 4; i <= 8; i++){
            ...
            if(i ==5){
                move_gripper(right_base_cyclic, MOVE_GRIPPER_5);
            }

            if(i == 6){
                move_gripper(left_base_cyclic, MOVE_GRIPPER_6); //55 
            }
            ...
            if(i == 8){
                move_gripper(left_base_cyclic, MOVE_GRIPPER_8); //50
