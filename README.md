...
> **Where to look:** the current code is [`Christian_control/`](Christian_control),
> my C++ controller for the dual-arm wearable robot (results in
> [msc_project](https://github.com/fechachris4/msc_project)). The root CMake
> project is retired: it cannot configure and has been renamed
