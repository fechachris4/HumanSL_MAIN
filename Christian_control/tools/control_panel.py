...
"""Control panel for the SRL controller — start it, then open a browser.
    ...
    python3 Christian_control/tools/control_panel.py --lan
    python3 Christian_control/tools/control_panel.py --replay runs/2026-08-11/loop_log_right_20260811_154613.csv
...
# Run as a script from anywhere: the panel package sits beside this file.
