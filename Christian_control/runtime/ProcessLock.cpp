...
{
    // Closing the last descriptor releases flock, including when the kernel
    // closes descriptors after a crash. Keep the file itself: unlinking it
    // would permit two processes to lock different inodes.
    ::close(fd_);
}
