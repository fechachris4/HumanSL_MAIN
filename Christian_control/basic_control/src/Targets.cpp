...
// The watched-target-file input (FirstTargetLine / RunPoseTargetFileInput)
// was removed 2026-08-04. It existed to serve the TOML front-end's
// target_file key, which was deleted with Options on 2026-08-03; since
// then kTargetFile was compiled empty, so the watcher thread never
// started. stdin is the one operator input. Git history has it.
