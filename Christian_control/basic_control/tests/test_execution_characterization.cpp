...
const char* const kProvenanceInputs[] = {
    "src/Actuation.cpp", "src/Actuation.h", "src/Arrival.h",
    ...
    "../cartesian_contract/WorldCartesianTrajectory.h",
    "config/GEN3_dual_mounted.urdf",
...
{
    const std::string source_dir = BASIC_CONTROL_SOURCE_DIR;
