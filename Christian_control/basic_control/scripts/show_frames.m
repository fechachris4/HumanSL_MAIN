...
% base_link (the "world" of goal.yaml, controller prints, pipe targets).
% Run:  show_frames
function show_frames()
    ...
    draw_triad(eye(3), [0 0 0], 0.25, 'base\_link (= world today)');
    ...
    title('base\_link is the world: goals, prints, and pipe targets live here');
end
